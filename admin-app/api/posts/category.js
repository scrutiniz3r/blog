...
const { setFrontmatterField, slugify } = require("../../lib/markdown");
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const updated = setFrontmatterField(existing.raw, "category", category);
    await putFile(`${POSTS_DIR}/${file}`, updated, `Set category on ${file}`, existing.sha);
